...
export default function Cardadd(props) {
    ...
    return (
        <div className='w-[500px] h-[400px] rounded-xl flex flex-col justify-center gap-2  items-center pe-5'>
            ...
            <div onClick={()=>{props.checked==true?props.setchecked(false):props.setchecked(true)}} className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox} ${props.checked==true?"bg-[#ECECEC]":""}  hover:border-[#9C82BC] rounded-xl border-[2px]`} >
            ...
            <div onClick={()=>{props.checked1==true?props.setchecked1(false):props.setchecked1(true)}} className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox1} ${props.checked1==true?"bg-[#ECECEC]":""} hover:border-[#9C82BC] rounded-xl border-[2px]`} >
            ...
            <div onClick={()=>{props.checked2==true?props.setchecked2(false):props.setchecked2(true)}} className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox2} ${props.checked2==true?"bg-[#ECECEC]":""} hover:border-[#9C82BC] rounded-xl border-[2px]`} >
