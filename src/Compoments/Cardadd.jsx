...
export default function Cardadd(props) {
    ...
    return (
        <div className='w-[500px] h-[400px] rounded-xl flex flex-col justify-center gap-2  items-center pe-5'>
            ...
            <div className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox} ${props.checked==true?"bg-[#ECECEC]":""}  hover:border-[#9C82BC] rounded-xl border-[2px]`} >
            ...
            <div className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox1} ${props.checked1==true?"bg-[#ECECEC]":""} hover:border-[#9C82BC] rounded-xl border-[2px]`} >
            ...
            <div className={`w-[400px] flex justify-center items-center h-[60px] ${checkedbox2} ${props.checked2==true?"bg-[#ECECEC]":""} hover:border-[#9C82BC] rounded-xl border-[2px]`} >
