...
export default function Cardinfo(props) {
    ...
    return (
        <div className='w-[500px] h-[400px] rounded-xl flex flex-col justify-center items-center pe-5 max-[375px]:w-[200px]'>
            ...
            <input onChange={(e)=>{setyourname(e.target.value)}} className="max-[375px]:w-[200px] flex justify-center items-center ps-3 mt-3  w-[400px] border-[2px] h-[40px] rounded-xl text-sm" placeholder="Your Name" type="text" />
            <p className="mt-3 text-start w-[400px] text-xs font-bold max-[375px]:w-[200px]">Your mail is : {yourmail}</p>
            <input onChange={(e)=>{setyourmail(e.target.value)}} className="max-[375px]:w-[200px] mt-3 ps-3 w-[400px] border-[2px] h-[40px] rounded-xl text-sm" placeholder="Your Mail" type="text" />
