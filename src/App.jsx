      ...
      <div className='bg-white rounded-2xl w-[820px] h-[500px] flex justify-center gap-[50px] items-center'>
       ...
       <div>
        ...
        <div className='h-[60px] flex justify-center items-center '>
          ...
          {
            active>1?<button onClick={()=>{setactive(active-1)}} className='me-[70px] w-[100px] h-[40px] text-sm rounded-xl font-bold flex justify-center items-center text-black'>Go Back</button>:""
          }
          </div>
          <div className='w-1/2 h-full flex justify-center items-center'>
          {
